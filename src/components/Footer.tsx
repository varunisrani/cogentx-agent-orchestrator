        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-foreground/70 hover:text-foreground">API References</a></li>
              <li><a href="#" className="text-foreground/70 hover:text-foreground">Tutorials</a></li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-foreground/70 hover:text-foreground">Legal</a></li>
            </ul>
          </div>
        </div>
