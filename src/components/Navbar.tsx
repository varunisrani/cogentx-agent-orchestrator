    ...
    <nav className="w-full py-4 px-4 md:px-8 flex items-center justify-between backdrop-blur-sm bg-background/50 sticky top-0 z-50 border-b border-white/10">
      <div className="flex items-center">
        <a href="/" className="flex items-center">
          <span className="font-display text-xl font-bold bg-gradient-to-r from-cogent-orange to-cogent-red bg-clip-text text-transparent hover:from-cogent-orange-hover hover:to-cogent-red-hover transition-colors">CogentX</span>
        </a>
      </div>
