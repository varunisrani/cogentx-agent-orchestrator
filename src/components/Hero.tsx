    ...
    <div className="relative w-full py-24 md:py-36 px-4 md:px-8 flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        <div className="mb-2 animate-fade-in opacity-0" style={{ animationDelay: "0.1s", animationFillMode: "forwards" }}>
          <span className="inline-flex items-center rounded-full px-3 py-1 text-sm font-medium bg-white/10 text-white/90 backdrop-blur-sm border border-cogent-orange/30">
            Introducing MCP
            <svg 
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-fade-in opacity-0" style={{ animationDelay: "0.9s", animationFillMode: "forwards" }}>
          <Button 
            size="lg" 
            variant="outline" 
            className="w-full sm:w-auto flex items-center justify-center group transition-all duration-300 hover:bg-gradient-to-r hover:from-cogent-orange/10 hover:to-cogent-red/10 backdrop-blur-sm border-cogent-orange/20 hover:border-cogent-orange/40"
            onClick={redirectToCogentX}
          >
            <Plus className="mr-2 h-5 w-5 transition-transform group-hover:rotate-90 duration-300 group-hover:text-cogent-orange" />
            <span className="relative overflow-hidden">
              <span className="inline-block transition-transform duration-300 group-hover:-translate-y-full">Build Your Agent</span>
              <span className="absolute top-0 left-0 -translate-y-full transition-transform duration-300 group-hover:translate-y-full text-cogent-orange">Get Started</span>
            </span>
          </Button>
          <Button 
            size="lg" 
            className="w-full sm:w-auto bg-cogent-orange hover:bg-cogent-orange-hover transition-all duration-300 hover:shadow-lg hover:shadow-cogent-orange/30"
            onClick={redirectToCogentX}
          >
            Try Demo
          </Button>
